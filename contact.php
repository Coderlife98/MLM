...
<body style="background-color: #0c0c0c;">
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header contact_hero py-5">
                            ...
                            <div class="alldetails">
                                ...
                                <div class="d-flex py-2">
                                    ...
                                    <div class="address">
                                        ...
                                        <a href="mailto:mlmgigsoftware@gmail.com" class="text-secondary">mlmgigsoftware@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- <div class="p-5 rounded contact-form"> -->
                       ...
                       <div class=" p-0 p-md-5 rounded ">
                            <div class="mb-4 add_borrrrr">
                                <input type="text" autocomplete="off" name="name"  oninput="this.value = this.value.toUpperCase().replace(/[^a-zA-Z ]/g, '').replace(/(  *?)/g, ' ')"
                                id="name" class="form-control input-transparent border-0 py-2" placeholder=" Name">
                            </div>
                            <div class="mb-4 add_borrrrr">
                                <input type="email" autocomplete="off" oninput="this.value = this.value.toUpperCase()" name="email" id="email" class="form-control input-transparent border-0 py-2" placeholder=" Email">
                            </div>
                            <div class="mb-4 add_borrrrr">
                                <input type="text" autocomplete="off" name="subject" id="subject" class="form-control input-transparent border-0 py-2" placeholder="Subject">
                            </div>
                            <div class="mb-4 add_borrrrr">
                                <textarea name="message" autocomplete="off" id="message" class="w-100 form-control border-0 input-transparent py-2" rows="3" cols="10"
                            ...
                            <div class="mb-4 add_borrrrr">
                                <input type="text" id="num" placeholder="Enter Captcha Here" class="form-control input-transparent border-0 py-2set-sum "
                                    onkeyup="myFunction()" />
                            </div>
                            

                            <div class="text-start">
                                <button class="btn bg-primary text-white  py-2 px-4" name="submit"  type="submit" onclick="return validate();">Send Message</button>
                            </div>
                        </div>
                       </form>
                    </div>
