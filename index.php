...
<body>
        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="img/hero1.png" class="img-fluid" alt="First slide">
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            ...
                            <a href="#" class="ms-2"><button type="button"
                                    class="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn2 animated fadeInRight">Mlm
                                    Software</button></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                ...
                <div class="col-lg-7 col-md-6 d-flex align-items-start justify-content-center flex-column col-sm-12 wow fadeInRight"
                    ...
                    <h1 class="mb-4 text-white">Best MLM Software Provider in Patna </h1>
                    <p class="text-white text-justify">Welcome to the leading <a href="" class="all_link_color">MLM
                        ...
                        comprehensive solution that caters to various structures, including <a href=""
                            class="all_link_color">Binary</a>, <a href="" class="all_link_color">Matrix</a>, and <a
                            href="" class="all_link_color">Unilevel</a>.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="compre_head">
                    ...
                    <div class="about_plan my-3">
                        <div class="plan_box d-flex align-items-center">
                          ...
                          <div class="about_pl">
                            <p class="mb-0 "><b>Binary Plan:</b> Optimize your <a href="" class="all_link_color">binary plan</a> operations with real-time tracking and management features</p>
                          </div>
                        </div>
                    </div>
                    <div class="about_plan ">
                        <div class="plan_box d-flex align-items-center">
                          ...
                          <div class="about_pl">
                            ...
                            <p class="mb-0 "><b> Matrix Plan:</b> Seamlessly manage your <a href="" class="all_link_color">matrix plans</a> with intuitive tools and reports.</p>
                          </div>
                        </div>
                    </div>
                    <div class="about_plan my-3">
                        <div class="plan_box d-flex align-items-center">
                          ...
                          <div class="about_pl">
                            ...
                            <p class="mb-0 "><b>Unilevel Plan: </b> Enhance your <a href="" class="all_link_color">unilevel plan </a>performance with advanced analytics and commission tracking.</p>
                          </div>
                        </div>
                    </div>
    ...
    <section>
    <div class="container-fluid py-2 py-lg-5 set_key_feature">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 my-2">
                    <div id="box p-3 ">
                        <img src="" alt="">
                        <p class="text-white text-center">User-Friendly Interface</p>
                        <p class="descri text-justify text-white">
                        Our software is designed with simplicity in mind, making it easy for users at all levels to navigate and utilize.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 my-2">
                     <div id="box text-white p-3">
                        <img src="" alt="">
                        <p class="text-white text-center">Real-Time Analytics</p>
                        <p class="descri text-justify text-white">
                       Gain valuable insights into your network’s performance with our detailed analytics and reporting tools.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 my-2">
                     <div id="box text-white p-3">
                        <img src="" alt="">
                        <p class="text-white text-center">Customizable Solutions</p>
                        <p class="descri text-justify text-white">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-2">
                     <div id="box text-white p-3">
                        <img src="" alt="">
                        <p class="text-white text-center">Secure and Reliable</p>
                        <p class="descri text-justify text-white">
                        Ensure your data is protected with our top-notch security measures and reliable infrastructure.
                        </p>
                    </div>
                </div>
            </div>
