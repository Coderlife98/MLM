            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7 col-sm-12 wow d-lg-flex align-items-center fadeInRight" data-wow-delay=".5s">
                    <div>
                        ...
                        <a href="./contact.php" class="btn btn-secondary rounded-pill px-5 py-2 text-white"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 py-4 d-flex flex-column justify-content-center  wow fadeInUp"
                        ...
                        <p class="text-justify ">
                            Experience with Number of Years of inspired teamwork and Positive Change, <a
                                href="./index.php" class="fw-bolder">Mlmgig</a> is
